...
class DifferentiallyPrivateSupportVectorMachine(svm.LinearSVC, DiffprivlibMixin):

    _parameter_constraints = DiffprivlibMixin._copy_parameter_constraints(svm.LinearSVC,
                                                                          "tol",
                                                                          "C",
                                                                          "fit_intercept",
                                                                          "max_iter",
    ...
    def __init__(self,
        ...
        Support vector machine with differential privacy base class. This class is a child of svm.LinearSVC.
